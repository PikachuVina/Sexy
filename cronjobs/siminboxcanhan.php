...
$res = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM siminboxcanhan ORDER BY RAND() LIMIT 0,5"); 
...
{ 
    ...
    if(!$userData[name]){ 
    mysqli_query($GLOBALS["___mysqli_ston"], " DELETE FROM siminboxcanhan WHERE token = '" . mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $token) . "' ");
    continue; 
    } 
